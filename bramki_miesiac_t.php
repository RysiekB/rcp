...
try 
{
    ...
    $NumerKier = $_SESSION['uzytkownik'];
    $sql = "SET NOCOUNT ON; EXEC dbo.TA_ListaPrac_TL ?";
    $stmt = $conn->prepare($sql);
    $stmt->bindParam(1, $NumerKier);
    $stmt->execute();
...
<html lang="pl">
    ...
    <hr> 
        ...
        <form method="post" action="bramki_miesiac_a1.php">
        ...
        <h4>Wybór pracownika</h4>
            ...
            <select name="pracownik">
				...
				<?php
                    ...
                    {
                        $nazwiskoimie = $row['NazwiskoImie'];
                        $_SESSION['numerid'] = "000".$row['Kod_pracownika'];
                        $wybor = $nazwiskoimie." ".$numerid;
